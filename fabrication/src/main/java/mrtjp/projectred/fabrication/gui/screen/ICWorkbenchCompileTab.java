...
public class ICWorkbenchCompileTab extends AbstractGuiNode implements ICRenderNode.IICRenderNodeEventReceiver {
    ...
    public void drawBack(MatrixStack stack, Point mouse, float partialFrame) {
        ...
        blit(stack, getFrame().x() + 208, getFrame().y() + 36, 304, 0, barWidth, 5, 512, 512);
        blit(stack, getFrame().x() + 208, getFrame().y() + 36, 304, 5, progress, 5, 512, 512);
    }
    ...
    public class CompileButton extends AbstractButtonNode {
        ...
        private void blitCentered(MatrixStack stack, int u, int v, int width, int height) {
            blit(stack,
