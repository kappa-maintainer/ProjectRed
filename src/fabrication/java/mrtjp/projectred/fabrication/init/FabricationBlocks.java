...
public class FabricationBlocks {
    ...
    public static void register() {
        ...
        TILE_ENTITIES.register(ID_PLOTTING_TABLE, () -> TileEntityType.Builder.of(PlottingTableTile::new, PLOTTING_TABLE_BLOCK).build(null));
        TILE_ENTITIES.register(ID_LITHOGRAPHY_TABLE, () -> TileEntityType.Builder.of(LithographyTableTile::new, LITHOGRAPHY_TABLE_BLOCK).build(null));
        TILE_ENTITIES.register(ID_PACKAGING_TABLE, () -> TileEntityType.Builder.of(PackagingTableTile::new, PACKAGING_TABLE_BLOCK).build(null));
    }
}
